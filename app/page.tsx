  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto">
        ...
        <CardSection
          title="Reward Redemption – Credit Card – AU SMALL FINANCE Bank"
        ...
        <CardSection
          title="Register Now – AU SMALL FINANCE Bank Credit Card"
          description="Enter your 16 digit AU SMALL FINANCE Bank Credit Card number, your name as it appears on the AU SMALL FINANCE Bank credit card, expiry month & year, and 3 digit CVV."
        />

        <CardSection
          title="Limit Increase"
          description="Check eligibility and apply instantly for a higher credit limit on your AU SMALL FINANCE Bank Credit Card."
        />
